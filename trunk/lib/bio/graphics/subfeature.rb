          ...
          def draw(track_drawing)
            ...
            case local_feature_glyph
              ...
              when :triangle
                ...
                left_pixel_of_subfeature = @pixel_range_collection[0].start_pixel - FEATURE_ARROW_LENGTH
                right_pixel_of_subfeature = @pixel_range_collection[0].stop_pixel + FEATURE_ARROW_LENGTH
                arrow(track_drawing,:north,left_pixel_of_subfeature + FEATURE_ARROW_LENGTH, @feature.top_pixel_of_feature, FEATURE_ARROW_LENGTH)
                track_drawing.close_path.stroke
              when :dot
                raise "Start and stop are not the same (necessary if you want dot glyphs)" if @start != @stop
                # Need to get this for the imagemap
                radius = FEATURE_HEIGHT/2
              ...
              when :line
                ...
                track_drawing.move_to(left_pixel_of_subfeature,@feature.top_pixel_of_feature+FEATURE_ARROW_LENGTH)               
                track_drawing.line_to(right_pixel_of_subfeature,@feature.top_pixel_of_feature+FEATURE_ARROW_LENGTH)
              ...
              when :line_with_handles
                ...
                arrow(track_drawing,:right,left_pixel_of_subfeature,@feature.top_pixel_of_feature,FEATURE_ARROW_LENGTH)
                track_drawing.close_path.stroke              
                arrow(track_drawing,:left,right_pixel_of_subfeature,@feature.top_pixel_of_feature,FEATURE_ARROW_LENGTH)
                track_drawing.close_path.stroke
            ...
            when :directed_generic
                ...
                if self.strand == -1 # Reverse strand
                  track_drawing.rectangle(left_pixel_of_subfeature+FEATURE_ARROW_LENGTH, @feature.top_pixel_of_feature, right_pixel_of_subfeature - left_pixel_of_subfeature - FEATURE_ARROW_LENGTH, FEATURE_HEIGHT).fill
                  arrow(track_drawing,:left,left_pixel_of_subfeature+FEATURE_ARROW_LENGTH,@feature.top_pixel_of_feature,FEATURE_ARROW_LENGTH)
                  track_drawing.close_path.fill
                else #default is forward strand
                  track_drawing.rectangle(left_pixel_of_subfeature, @feature.top_pixel_of_feature, right_pixel_of_subfeature - left_pixel_of_subfeature - FEATURE_ARROW_LENGTH, FEATURE_HEIGHT).fill
                  arrow(track_drawing,:right,right_pixel_of_subfeature-FEATURE_ARROW_LENGTH,@feature.top_pixel_of_feature,FEATURE_ARROW_LENGTH)
                  track_drawing.close_path.fill
                end
              when :spliced
                # Need to get this for the imagemap
              ...
              when :directed_spliced
                ...
                if @strand == -1 # reverse strand => box with arrow is first one
                  ...
                  track_drawing.rectangle((range_with_arrow.start_pixel)+FEATURE_ARROW_LENGTH, @feature.top_pixel_of_feature, range_with_arrow.stop_pixel - range_with_arrow.start_pixel - FEATURE_ARROW_LENGTH, FEATURE_HEIGHT).fill
                  arrow(track_drawing,:left,range_with_arrow.start_pixel+FEATURE_ARROW_LENGTH, @feature.top_pixel_of_feature,FEATURE_ARROW_LENGTH)
                  track_drawing.close_path.fill
                else # forward strand => box with arrow is last one
                  range_with_arrow = pixel_ranges.pop
                  track_drawing.rectangle(range_with_arrow.start_pixel, @feature.top_pixel_of_feature, range_with_arrow.stop_pixel - range_with_arrow.start_pixel - FEATURE_ARROW_LENGTH, FEATURE_HEIGHT).fill
                  arrow(track_drawing,:right,range_with_arrow.stop_pixel-FEATURE_ARROW_LENGTH, @feature.top_pixel_of_feature,FEATURE_ARROW_LENGTH)
                  track_drawing.close_path.fill
                end
                ...
                left_pixel_of_subfeature, right_pixel_of_subfeature = @pixel_range_collection[0].start_pixel, @pixel_range_collection[0].stop_pixel
                track_drawing.rectangle(left_pixel_of_subfeature, @feature.top_pixel_of_feature, (right_pixel_of_subfeature - left_pixel_of_subfeature), FEATURE_HEIGHT).fill
            end
